...
<div id="hot">
    ...
    <div>
        <ul>
            <li><a href="./jump?flag=${AoMenTitle.get(0)}"><img src="${AoMenPhoto.get(0) }" class="img-rounded"/>${AoMenTitle.get(0)}</a></li>
            <li><img src="${AoMenPhoto.get(1) }"><a href="./jump?flag=${AoMenTitle.get(1)}">${AoMenTitle.get(1)}</a></li>
            <li><img src="${AoMenPhoto.get(2) }"><a href="./jump?flag=${AoMenTitle.get(2)}">${AoMenTitle.get(2)}</a></li>
            <li><img src="${AoMenPhoto.get(3) }"><a href="./jump?flag=${AoMenTitle.get(3)}">${AoMenTitle.get(3)}</a></li>
            <li><img src="${AoMenPhoto.get(4) }"><a href="./jump?flag=${AoMenTitle.get(4)}">${AoMenTitle.get(4)}</a></li>
            <li><img src="${AoMenPhoto.get(5) }"><a href="./jump?flag=${AoMenTitle.get(5)}">${AoMenTitle.get(5)}</a></li>
            <li><a href="./ShowAoMenDetail">更多</a></li>
        </ul>
    </div>
