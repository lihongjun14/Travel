...
<div id="hot">
    ...
    <div>
        <ul>
            <li><img src="${ZhongShanPhoto.get(0)}"><a href="./jump?flag=${ZhongShanTitle.get(0)}">${ZhongShanTitle.get(0)}</a></li>
            <li><img src="${ZhongShanPhoto.get(1)}"><a href="./jump?flag=${ZhongShanTitle.get(1)}">${ZhongShanTitle.get(1)}</a></li>
            <li><img src="${ZhongShanPhoto.get(2)}"><a href="./jump?flag=${ZhongShanTitle.get(2)}">${ZhongShanTitle.get(2)}</a></li>
            <li><img src="${ZhongShanPhoto.get(3)}"><a href="./jump?flag=${ZhongShanTitle.get(3)}">${ZhongShanTitle.get(3)}</a></li>
            <li><img src="${ZhongShanPhoto.get(4)}"><a href="./jump?flag=${ZhongShanTitle.get(4)}">${ZhongShanTitle.get(4)}</a></li>
            <li><img src="${ZhongShanPhoto.get(5)}"><a href="./jump?flag=${ZhongShanTitle.get(5)}">${ZhongShanTitle.get(5)}</a></li>
            <li><a href="./ShowZhongShanDetail">更多</a></li>
        </ul>
    </div>
